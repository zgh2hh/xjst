<template>
  <div class="operate-wrapper">
    ...
    <!-- 列表 -->
    <el-row :gutter="0">
      <ag-grid-vue class="ag-fresh" style="height:600px;" :gridOptions="gridOptions" :rowData="rowData" rowSelection="multiple" :rowSelected="onRowSelected" :localeText='localeText'>
      </ag-grid-vue>
    </el-row>
    <!-- 操作按钮 -->
    <el-row>
