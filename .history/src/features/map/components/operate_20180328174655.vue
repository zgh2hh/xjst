<template>
  <div class="operate-wrapper">
    <el-row type="flex" justify="center" style="padding: 5px 0;">
      ...
      <el-col :span="2">
        <color-picker v-on:change="headleChangeColor" ref="colorPicker"></color-picker>
      </el-col>
      <el-col :span="2">
...
export default {
  ...
  methods: {
    createColumnDefs() {
      return [
        ...
        },
        {
          ...
          width: 30,
          suppressSorting: true,
          cellRenderer: this.createColorPanel
        },
        {
          headerName: '描述',
          field: 'desc',
    ...
    createColorPanel(params) {
      ...
      return `<div style="width:10px;height:10px;background-color:${this.color}">12</div>`
    },
