  ...
  <el-container>
    <el-main width="100%">
      ...
      <div class="side" v-show="showAside">
        ...
        <operate class="operate" @updated="loadTracks" @selectedRowsChanged="selectRecords" @display='display' :inRangePoints='inRangePoints' :updatedMarker='updatedMarker'></operate>
      </div>
...
export default {
  ...
  data() {
    ...
    return {
      zoom: 13,
      center: [33.36, 44.49],
      bounds: [[34.524316150465104, 69.14186843865969], [34.524033291265916, 69.20598396295168], [34.559383245309505, 69.20795806878664]],
      url: config.url,
      monitors: [],
      selectedIds: [],
      // 框选出来的点
